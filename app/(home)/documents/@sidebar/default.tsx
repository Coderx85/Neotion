...
const Navigation = () => {
  ...
  // Sync with global sidebar state
  useEffect(() => {
    ...
    <>
      ...
      >
        <div>
          <div
            className={cn(
              `w-9 h-9 p-1 cursor-pointer text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute
              top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition duration-300`,
