    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        {displayUrl ? (
          ...
          >
            <BiSolidCloudUpload className="mb-1 h-7 w-7" />
        ...
        {displayUrl &&
          ...
          fileState.status !== 'COMPLETE' && (
            ...
            >
              {fileState.status === 'UPLOADING' ? (
                <BiXCircle className="block h-4 w-4 text-muted-foreground" />
              ) : (
                <BiSolidTrash className="block h-4 w-4 text-muted-foreground" />
              )}
            </button>
          )}
      </div>
      ...
      {errorMessage && (
        <div className="mt-2 flex items-center text-xs text-destructive">
          <BiAlarmExclamation className="mr-1 h-4 w-4" />
